...
| [0008](0008-data-residency.md) | Hosting region and cross-border disclosure | Accepted |
| [0009](0009-separate-database.md) | New database; legacy history imported by a private ETL | Accepted |
